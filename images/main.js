...
function catchLogValues() {
    ...
    if (userEmail === orgEmail && userPassword === orgPassword) {
        let logCard = `<div class = "card2">
        <img class ="icon" src="images/icons8-login-64.png" alt="#">
        ...
        let logCard = `<div class = "card">
          <img src="images/icons8-error-96.png" alt="#">
            <h3>Invalid Email or Password</h3> 
            <button id="log-do-btn" onclick = "reloadPage()">Back to Login</button>
            </div>`
        popUpContainer.innerHTML = logCard;
    }
